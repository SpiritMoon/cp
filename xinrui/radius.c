 ...
 *@return
 */
int radius12_pro_recv(struct radius_recv *rr)
{
...
#if RADIUS_DEBUG
	xyprintf(0, "1812:username = %s", username);
#endif

	// 回复报文
	radius12_pro_recv(rr);
...
#if RADIUS_DEBUG
	xyprintf(0, "1813:username = %s", username);
#endif
...
#if RADIUS_DEBUG
	xyprintf(0, "1813:usermac = %s", usermac);
#endif
...
#if RADIUS_DEBUG
	xyprintf(0, "1813:acct_status_type = %u", acct_status_type);
#endif
...
#if RADIUS_DEBUG
	xyprintf(0, "1813:userip = %s", userip);
#endif
